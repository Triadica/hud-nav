...
{} (:about "|Machine-generated snapshot. Do not edit directly — changes will be overwritten. Use `calcit query` to inspect and `calcit edit`/`calcit tree` to modify. Run `calcit docs agents --full` first. Manual edits must follow format and schema conventions, then run `calcit edit format`.") (:package |hud-nav)
  :entries $ {}
    :default $ {} (:description |) (:init-fn 'hud-nav.main/main!) (:mode :js) (:reload-fn 'hud-nav.main/reload!)
      :feature-policy $ {}
  ...
  :files $ {}
    ...
    'hud-nav.schema $ %{} 'FileEntry
      :defs $ {}
        'Op $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defenum Op (:tab 'hud-nav.schema/Tab) (:hydrate-storage 'Dynamic)
          :examples $ []
          :schema $ :: 'Enum
        'Store $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defstruct Store $ :tab 'hud-nav.schema/Tab
          :examples $ []
          :schema $ :: 'Enum
        'Tab $ %{} 'CodeEntry (:doc |)
        ...
        'TabItem $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defstruct TabItem (:id 'hud-nav.schema/Tab) (:label 'String)
          :examples $ []
          :schema $ :: 'Enum
        'store $ %{} 'CodeEntry (:doc |)
          :code $ quote
            def store $ %{} Store (:tab :a)
          :examples $ []
